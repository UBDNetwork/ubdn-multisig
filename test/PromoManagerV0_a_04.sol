...
contract PromoManagerV0_a_04 is Test {
    ...
    function test_promo_1() public {
        ...
        assertEq(infoFee.fee.payedTill, currentTime + multisig_instance.ANNUAL_FEE_PERIOD() + promoPeriod); // +365 day of promo
        assertEq(infoFee.freeHoldPeriod, currentTime + promoPeriod); // +365 day of promo
